                                ...
                                <div className="card-body">
                                    <ul className="mda-list">
                                        <li className="mda-list-item pl0 bb">
                                            ...
                                            <div className="pull-right">
                                                <div className="pt-lg"><em tooltip="Active" className="icon-2x ion-checkmark-circled text-success"></em></div>
                                            </div>
                                        </li>
                                        <li className="mda-list-item pl0 bb">
                                            <div className="mda-list-item-text">
                                        ...
                                        <li className="mda-list-item pl0">
                                            ...
                                            <div className="pull-right">
                                                <div className="pt-lg"><em tooltip="Pending" className="icon-2x ion-minus-circled text-warning"></em></div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
