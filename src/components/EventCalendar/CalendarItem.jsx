...
class CalendarItem extends Component {
    ...
    render() {
      ...
      const containerClass = this.props.className || cx({
        'col-xs-12': true,
        'col-md-6': this.props.suggested
      });
      return (
        <div className={containerClass}>
          <Col xs={12}>
            <a href="#" className={cardClasses} onClick={this.whenYouPokeItItGrows}>
              {this.props.suggested ? <div className="card-item">
                <img alt="because facebook's annoying" src="/img/pic2.jpg" className="img-responsive" />
              </div> : null}
